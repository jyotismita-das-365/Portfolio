...
const About = () => {
  return (
    <>
      <div className="bg-black text-white flex sm:flex sm:flex-col">
        <div>
        ...
        <img src={Jyoti} alt="" className="border-8 border-double border-white rounded-full h-40 mb-10 ml-10 lg:h-1/3"/>
      </div>
    </>
  );
};
